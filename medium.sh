...
#    Updated: 2022/11/24 17:13:10 by lolemmen         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
do
	...
	if [ $COUNT -gt 700 ]
	then
		echo "${LOG_YELLOW} Your push_swap does more than 700 instructions [$COUNT] to resolve this test : \n${LOG_NOCOLOR}${ARG}"
		let "warning+=1";
	fi
	echo
done
